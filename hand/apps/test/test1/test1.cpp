...
void App::Init()
{
    ...
    Add(Output);
    // Add controls
    folder = new FunctoidList("Level 1");
    Add(folder);

    // Set the dummy callback methods
    FunctoidList* func_folder = new FunctoidList("button 1");
    ...
    func_folder = new FunctoidList("button 2");
    ...
    FunctoidList* sub_menu = new FunctoidList("Level 2");
    sub_menu->Add(new Note(TAG_DESCRIPTION, "l1b3: calls sub-menu"));
    folder->Add(sub_menu);
    // Set the dummy callback methods
    func_folder = new FunctoidList("button 1");
    func_folder->Add(new Callback<App>("button 1", this, &App::PrintSelf));
    ...
    func_folder = new FunctoidList("button 3");
    ...
    func_folder = new FunctoidList("button 4");
    ...
    func_folder = new FunctoidList("button 5");
